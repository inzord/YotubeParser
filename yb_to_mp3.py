...
class UrlToMp3:
    def __init__(self, urls: [str], path_out: str, max_threads=5):
        self.urls = urls
        ...
        try:
            if link.find(self.params.PLAYLIST_CHECK) >= 0:
                if self.check == self.params.MIX_CHECK:
                    ...
                    for lin in new_data:
                        self.download_and_convert_video(lin)
                else:
...
#                ],
#          path_out=r'C:\Users\\OneDrive\Рабочий стол\music\test1').process()
...
#                "https://youtube.com/playlist?list=RDqRsEjSBhtWo&playnext=1&si=AAw1pkniZVjvftAo"
#                ],
#          path_out=r'C:\Users\dfrty\OneDrive\Рабочий стол\music\test1').process()

# "PLAYLIST"
# UrlToMp3(urls=["https://www.youtube.com/playlist?list=PLgULlLHTSGIQ9BeVZY37fJP50CYc3lkW2"],
#          path_out=r'C:\Users\\OneDrive\Рабочий стол\music\test').process()

# "VIDEO"
# UrlToMp3(urls=["https://www.youtube.com/watch?v=bFoFN9Sbk2w", "https://www.youtube.com/watch?v=1ll3FvVk6BA",
#                "https://www.youtube.com/watch?v=lVIpOaoDzn8", "https://www.youtube.com/watch?v=dge1x3g3jZE"],
#          path_out=Params().PATH_OUT, max_threads=5).process()
